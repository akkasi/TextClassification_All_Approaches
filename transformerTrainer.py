...
import numpy as np
import gc
def bert_trainer(model, train_dataloader, loss_fn,optimizer, device, val_dataloader=None, epochs=4, evaluation=True):
# def bert_trainer(model, train_dataloader, loss_fn, optimizer,device, val_dataloader=None, epochs=4,evaluation=False):
    ...
    for epoch_i in range(epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            # print('target.size()', b_labels.size())
        ...
        if evaluation == True:
            ...
            print(f"{epoch_i + 1:^7} | {step:^7} | {avg_train_loss:^12.6f} | {val_loss:^10.6f} | {val_accuracy:^9.2f} | {time_elapsed:^9.2f}")
            print("-" * 70)
